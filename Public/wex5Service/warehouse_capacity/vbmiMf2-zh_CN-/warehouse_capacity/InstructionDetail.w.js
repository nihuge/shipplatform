...
var __parent0=require('$model/UI2/warehouse_capacity/InstructionDetail'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='cVJ73Yz';
	this._flag_='cc36da400c616cb54e73294aecbd6054';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"id":{"define":"id","name":"id","relation":"id","type":"String"},"shipname":{"define":"shipname","name":"shipname","relation":"shipname","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","limit":20,"xid":"shipData"});
 new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"id":{"define":"id","label":"值","name":"id","relation":"id","type":"String"},"shipname":{"define":"shipname","label":"显示名称","name":"shipname","relation":"shipname","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","initData":"[{\"id\":\"11111\",\"shipname\":\"aaaaa\"},{},{},{},{},{},{},{}]","limit":20,"xid":"itemData"});
 new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"id":{"define":"id","label":"仓id","name":"id","relation":"id","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","initData":"[{}]","limit":20,"xid":"shipDataModer"});
