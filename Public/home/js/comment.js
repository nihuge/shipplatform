...
jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		title_format	: null,
		info_format	: null,
		image	: './Public/home/img/comment/stars.jpg',
		imageAll :'./Public/home/img/comment/stars-all.gif',
		defaultTips :true,
		clickTips :true,
		width	: 24,
		height	: 24
	...
	//显示结果区域
	var result= jQuery('<div class="rater-star-result"></div><input type="hidden" name="grade" value="" id="StarNum">');
