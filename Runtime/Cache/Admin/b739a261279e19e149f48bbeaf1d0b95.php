    ...
    <div class="page-container">
        <div class="col-sm-12">
            <div id="home4" class="tab-pane in active">
                <form action="/admin.php?s=/AuthGroup/edit" method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
                        <tr>
                            <td>用户组名称</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="title" value="<?php echo ($msg['title']); ?>" required/>
                            </td>
                        </tr>
                        <tr>
