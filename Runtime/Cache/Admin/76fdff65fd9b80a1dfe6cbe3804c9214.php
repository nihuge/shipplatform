	...
	<div class="page-container">
		<div class="col-sm-12">
            <div id="home4" class="tab-pane in active">
	        	<!-- 新增公司管理 -->
				<form action="/admin.php?s=/Firm/adminmsg" method="post">
					<input type="hidden" name="firmid" value="<?php echo ($id); ?>">
					<input type="hidden" name="pid" value="0">
					<input type="hidden" name="id" value="<?php echo ($usermsg['id']); ?>">
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-15 col-sm-6" name="title" value="<?php echo ($usermsg['title']); ?>" <?php echo empty($usermsg) ? 'required' : 'readonly';?>/>
                            </td>
                        </tr>
                        <tr>
                            <td>用&nbsp;户&nbsp;&nbsp;名</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-6" name="username" required value="<?php echo ($usermsg['username']); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td>联系电话</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-6" name="phone" value="<?php echo ($usermsg['phone']); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td>公司名称</td>
                            <td>
                                <input type="text" name="firmname" value="<?php echo ($firmname); ?>" readonly class="col-xs-10 col-sm-6">
                            </td>
                        </tr>
                        <tr>
