    ...
    <div class="page-container">
        <div class="col-sm-12">
            <div id="home4" class="tab-pane in active">
                <form action="/admin.php?s=/User/edit" method="post">
                    <input type="hidden" name="id" id='uid' value="<?php echo ($usermsg['id']); ?>">
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
                        <tr>
                            <td style="width:120px;">账 &nbsp;&nbsp;&nbsp;&nbsp;号</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" name="title" readonly value="<?php echo ($usermsg['title']); ?>"  maxlength="15"/>
                            </td>
                        </tr>
                        <tr>
                            <td>用&nbsp;户&nbsp;&nbsp;名</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="username" value="<?php echo ($usermsg['username']); ?>" maxlength="15"/>
                            </td>
                        </tr>
                        <tr>
                            <td>联系电话</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="phone" value="<?php echo ($usermsg['phone']); ?>" maxlength="14"/>
                            </td>
                        </tr>
                        <tr>
                            <td>公司名称</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="firmname" readonly value="<?php echo ($firmmsg['firmname']); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td>操作权限</td>
                            <td id="ajaxship">
                                 <?php if(is_array($shiplist)): $i = 0; $__LIST__ = $shiplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!-- <label>
                                    <?php echo ($v['shipname']); ?>
                                    <input type="checkbox" name='operation_jur[]' value="<?php echo ($v['id']); ?>" <?php echo in_array($v['id'],$operation_jur) ? 'checked' : '';?>>&nbsp;
                                </label> -->
                                <label>
                                    <input class="ace ace-checkbox-2" type="checkbox" name='operation_jur[]' <?php echo in_array($v['id'],$operation_jur) ? 'checked' : '';?> value="<?php echo ($v['id']); ?>"/>
                                    <span class="lbl"> <?php echo ($v['shipname']); ?></span> 
