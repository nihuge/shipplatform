	...
	<div class="page-container">
		...
		<table id="sample-table-1" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<th>实高</th>
				<th>空高</th>
				<?php if(is_array($r)): $i = 0; $__LIST__ = $r;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><th>纵倾值<?php echo ($v); ?>/m</th><?php endforeach; endif; else: echo "" ;endif; ?>
				<th>舱名</th>
				<th>操作</th>
			</tr>
			</thead>
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr align='center'>
					<td><?php echo ($v['sounding']); ?></td>
					<td><?php echo ($v['ullage']); ?></td>
					<td><?php echo ($v['trimvalue1']); ?></td>
					<td><?php echo ($v['trimvalue2']); ?></td>
					<td><?php echo ($v['trimvalue3']); ?></td>
					<td><?php echo ($v['trimvalue4']); ?></td>
					<td><?php echo ($v['trimvalue5']); ?></td>
					<td><?php echo ($v['trimvalue6']); ?></td>
					<td><?php echo ($v['trimvalue7']); ?></td>
					<td><?php echo ($v['trimvalue8']); ?></td>
					<td><?php echo ($v['trimvalue9']); ?></td>
					<td><?php echo ($v['trimvalue10']); ?></td>
					<td><?php echo ($v['trimvalue11']); ?></td>
					<td><?php echo ($v['cabinname']); ?></td>
					<td>
                        <a href="<?php echo U('Zongxiu/edit',array('id'=>$v['id'],'tname'=>$tname));?>">修改</a>
                    </td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			<tr>
				<td colspan=15 class="pages"><?php echo ($page); ?></td>
			</tr>
		</table>
	</div>
