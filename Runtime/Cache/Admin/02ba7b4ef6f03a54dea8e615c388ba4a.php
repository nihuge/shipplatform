            ...
            <div id="home1" class="tab-pane in active">
                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(!empty($lists)): if(is_array($lists)): foreach($lists as $key=>$row): if($key > 1): ?><tr>
                                    ...
                                    <td style="text-align: left"><a href="<?php echo U('MySQLReBack/index',array('Action'=>'download','File'=>$row));?>"><?php echo ($row); ?></a></td>
                                    <td><?php echo (getfiletime($row,$datadir)); ?></td>
                                    <td><?php echo (getfilesize($row,$datadir)); ?></td>
                                    <td>
                                        <a href="<?php echo U('MySQLReBack/index',array('Action'=>'download','File'=>$row));?>">下载</a>
                                        <a onclick="return confirm('确定将数据库还原到当前备份吗？')" href="<?php echo U('MySQLReBack/index',array('Action'=>'RL','File'=>$row));?>">还原</a>
                                        <a onclick="return confirm('确定删除该备份文件吗？')" href="<?php echo U('MySQLReBack/index',array('Action'=>'Del','File'=>$row));?>">删除</a>
                                    </td>
                    ...
                    <tr>
                        <td>
                            <input type="button" name="sub" value="备份添加" class="btn btn-sm btn-primary" onClick="location.href = '/admin.php?s=/MySQLReBack/index/Action/backup'">
                        </td>
                        <td colspan='4'></td>
                    </tr>
                </table>
