...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="page-container">
        <div>
            <a href="<?php echo U('Article/add');?>" class="btn btn-primary">新增</a>
        </div>
        <h4></h4>
		<table id="sample-table-1" class="table table-striped table-bordered table-hover">
			...
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr align='center'>
					<td><img src="<?php echo ($v['pic_path']); ?>" style="width: 50px;height: 50px;"></td>
					<td><?php echo ($v['title']); ?></td>
					<td><?php echo ($v['addtime']); ?></td>
					<td><?php echo ($v['is_show'] == '1' ? '显示' : '不显示'); ?></td>
					<td>
                        <a href="<?php echo U('Article/edit',array('aid'=>$v['aid']));?>">修改</a>&nbsp;|&nbsp;
                        <a href="javascript:;" onclick="del('<?php echo ($v['aid']); ?>')" >删除</a>
                    </td>
