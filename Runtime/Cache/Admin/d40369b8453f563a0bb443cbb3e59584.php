...
<div class="main-container ace-save-state" id="main-container">
	...
	<div class="page-container">
		<table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
            <form action="/admin.php?s=/Zongxiu/edit" method="post">
            <input type="hidden" name="id" value="<?php echo ($msg['id']); ?>">
            <input type="hidden" name="tname" value="<?php echo ($tname); ?>">
            <tr>
                <td>所属仓</td>
                <td>
                    <select class=" col-xs-10 col-sm-5" id="form-field-select-1" name="cabinid" required>
                        <?php if(is_array($cabinlist)): $i = 0; $__LIST__ = $cabinlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['id']); ?>" 
                            <?php if($msg['cabinid'] == $v['id']): ?>selected<?php endif; ?>
                             ><?php echo ($v['cabinname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">实高</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['sounding']); ?>" name="sounding"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">空高</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['ullage']); ?>" name="ullage"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值-0.4/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue1']); ?>" name="trimvalue1"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值-0.2/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue2']); ?>" name="trimvalue2"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值0/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue3']); ?>" name="trimvalue3"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值0.2/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue4']); ?>" name="trimvalue4"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值0.4/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue5']); ?>" name="trimvalue5"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值0.6/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue6']); ?>" name="trimvalue6"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值0.8/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue7']); ?>" name="trimvalue7"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值1/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue8']); ?>" name="trimvalue8"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值1.2/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue9']); ?>" name="trimvalue9"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值1.4/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue10']); ?>" name="trimvalue10"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">纵倾值1.6/m</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['trimvalue11']); ?>" name="trimvalue11"/>
                </td>
            </tr>
            <tr>
