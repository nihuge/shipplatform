	...
	<div class="page-container">
		...
		<table id="sample-table-1" class="table table-striped table-bordered table-hover">
			...
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr align='center'>
					...
					<td><?php echo ($v['tripbystern1']); ?></td>
					<td><?php echo ($v['tripbystern2']); ?></td>
					<td><?php echo ($v['tripbystern3']); ?></td>
					<td><?php echo ($v['tripbystern4']); ?></td>
					<td><?php echo ($v['tripbystern5']); ?></td>
					<td><?php echo ($v['tripbystern6']); ?></td>
					<td><?php echo ($v['tripbystern7']); ?></td>
					<td><?php echo ($v['cabinname']); ?></td>
					<td>
                        <a href="<?php echo U('Tripbystern/edit',array('id'=>$v['id'],'tname'=>$tname));?>">修改</a>
                    </td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			<tr>
				<td colspan=11 class="pages"><?php echo ($page); ?></td>
			</tr>
		</table>
	</div>
