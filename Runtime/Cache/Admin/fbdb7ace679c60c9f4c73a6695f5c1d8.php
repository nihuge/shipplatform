...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="page-container">
        <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:900px;margin:auto auto;text-align: center;'>
            <form action="/admin.php?s=/Ship/edit" method="post">
            <tr>
                <td>船舶图片</td>
                <td>
                    <img class="normalFace" src="<?php echo ($shipmsg['img'] == '') ? '/Public/Admin/noimg.png' : $shipmsg['img'];?>" onclick="fileSelect1();" style='width: 150px;height: 110px;'>
                    <input type="file" name="photo1" id="photo1" value="<?php echo ($shipmsg['img'] == '') ? '/Public/Admin/noimg.png' : $shipmsg['img'];?>" class="filepath1" style="display:none;">
                    <input type="text" name="img" id="img" value="<?php echo ($shipmsg['img'] == '') ? '/Public/Admin/noimg.png' : $shipmsg['img'];?>" style="display:none;">
                </td>
            </tr>
            <input type="hidden" name="id" value="<?php echo ($shipmsg['id']); ?>">
            <tr>
                <td style="width:150px;">船名</td>
                <td>
                    <input type="text" class="wid" required name="shipname"  maxlength="15" value="<?php echo ($shipmsg['shipname']); ?>"/>
                </td>
            </tr>
            <tr>
                <td>所属公司</td>
                <td>
                    <select class="wid" name="firmid" required>
                        <?php if(is_array($firmlist)): $i = 0; $__LIST__ = $firmlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['id']); ?>" <?php echo ($v['id'] == $shipmsg['firmid'] ? 'selected' : ''); ?>><?php echo ($v['firmname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
                <td>舱材料膨胀倍数</td>
                <td>
                    <input type="text" class="wid" required name="coefficient"  maxlength="15" value="<?php echo ($shipmsg['coefficient']); ?>"/>
                </td>
            </tr>
            <tr>
                <td>舱总数</td>
                <td>
                    <input type="text" class="wid" required name="cabinnum" maxlength="2" value="<?php echo ($shipmsg['cabinnum']); ?>"/>
                </td>
            </tr>
            <tr>
                <td>编号</td>
                <td>
                    <input type="text" class="wid" required  name="number" maxlength="50"  value="<?php echo ($shipmsg['number']); ?>"/>
                </td>
            </tr>
            <tr>
                <td>舱容到期时间</td>
                <td>
                    <input class="wid" id="test1" name="expire_time" required value="<?php echo (date('Y-m-d',$shipmsg['expire_time'])); ?>">
                </td>
            </tr>
            <tr>
                <td>算法</td>
                <td>
                    <!-- <input type="text" class="wid" required  name="suanfa" maxlength="15" value="<?php echo ($shipmsg['suanfa']); ?>"/> -->

                    <select class="wid" name="suanfa" required>
                        <option value="a" <?php echo ($shipmsg['suanfa'] == "a" ? 'selected' : ''); ?>>a</option>
                        <option value="b" <?php echo ($shipmsg['suanfa'] == 'b' ? 'selected' : ''); ?>>b</option>
                        <option value="c" <?php echo ($shipmsg['suanfa'] == 'c' ? 'selected' : ''); ?>>c</option>
                    </select>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
                        ...
                        <?php echo ($shipmsg['is_guanxian'] == '1' ? 'checked' : ''); ?>
                        />
                    ...
                    <label>
                        ...
                        <?php echo ($shipmsg['is_guanxian'] == '2' ? 'checked' : ''); ?>
                        />
            ...
            <tr>
                <td>货名</td>
                <td>
                    <input type="text" class="wid" required  name="goodsname" value="<?php echo ($shipmsg['goodsname']); ?>" maxlength="15" />
                </td>
            </tr>
            <tr>
                <td>识别号</td>
                <td>
                    <input type="text" class="wid"  name="shibie_num" value="<?php echo ($shipmsg['shibie_num']); ?>" maxlength="20" />
                </td>
            </tr>
            <tr>
                <td>制造单位</td>
                <td>
                    <input type="text" class="wid"  name="make" value="<?php echo ($shipmsg['make']); ?>" maxlength="25" />
                </td>
            </tr>
            <tr>
                <td>类型</td>
                <td>
                    <input type="text" class="wid"  name="type" value="<?php echo ($shipmsg['type']); ?>" maxlength="8" />
                </td>
            </tr>
            <tr>
                <td>吨位</td>
                <td>
                    <input type="text" class="wid"  name="weight" value="<?php echo ($shipmsg['weight']); ?>" maxlength="8" />
                </td>
            </tr>
            <tr>
                <td>刻度值</td>
                <td>
                    <?php $__FOR_START_10947__=1;$__FOR_END_10947__=15;for($i=$__FOR_START_10947__;$i < $__FOR_END_10947__;$i+=1){ ?><input type="text" style="width: 50px;margin-right: 10px;margin-top: 5px;" name="kedu[]" maxlength="5" value="<?php echo ($kedu[$i-1]); ?>"/><?php } ?>
                </td>
            </tr>
            <tr id='tname1' style="display: {@:($shipmsg['suanfa'] == 'c') ? 'block' : 'none'@}">
                <?php if($shipmsg['suanfa'] == 'c'): ?><td>底量表纵倾刻度值</td>
                    <td>
                        <?php $__FOR_START_20288__=1;$__FOR_END_20288__=15;for($i=$__FOR_START_20288__;$i < $__FOR_END_20288__;$i+=1){ ?><input type="text" style="width: 50px;margin-right: 10px;margin-top: 5px;" name="kedu1[]" maxlength="5" value="<?php echo ($kedu1[$i-1]); ?>"/><?php } ?>
                    </td><?php endif; ?>
            </tr>
            <tr>
