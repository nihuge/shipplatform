    ...
    <div class="page-container">
        <div class="col-sm-12">
            <div id="home4" class="tab-pane in active">
                <form action="/admin.php?s=/Admin/edit" method="post">
                    <input type="hidden" name="id" id='uid' value="<?php echo ($msg['id']); ?>">
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" name="title" maxlength="15" readonly value="<?php echo ($msg['title']); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td>用&nbsp;户&nbsp;&nbsp;名</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="name" maxlength="15" value="<?php echo ($msg['name']); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td>联系电话</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="phone" maxlength="14" value="<?php echo ($msg['phone']); ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>用户角色</td>
                            <td>
                                <?php if(is_array($grouplist)): $i = 0; $__LIST__ = $grouplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><label>
                                        <input name="group_id[]" class="ace ace-checkbox-2" type="checkbox" value="<?php echo ($v['id']); ?>" 
                                        <?php echo in_array($v[id],$accesslist) ? 'checked':'';?>/>
