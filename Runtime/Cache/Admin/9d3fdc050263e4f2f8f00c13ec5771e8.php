    ...
    <div class="page-container">
        <div class="col-sm-12">
            <div id="home4" class="tab-pane in active">
                <form action="/admin.php?s=/AuthRule/add" method="post">
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
                        ...
                        <tr>
                            <td>权限中文名称</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-15 col-sm-8" name="title" required/>
                            </td>
                        </tr>
                        <tr>
                            <td>权限英文名称</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="name" required/>
                            </td>
                        </tr>
                        <tr>
