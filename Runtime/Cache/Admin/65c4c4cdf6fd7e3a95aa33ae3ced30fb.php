    ...
    <div class="page-container">
        <div class="col-sm-12">
            <div id="home4" class="tab-pane in active">
                <form action="/admin.php?s=/User/add" method="post">
                    <input type="hidden" name="firmid" value="<?php echo ($firmmsg['id']); ?>">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" name="title" maxlength="15" required/>
                            </td>
                        </tr>
                        <tr>
                            <td>用&nbsp;户&nbsp;&nbsp;名</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="username"  maxlength="15" />
                            </td>
                        </tr>
                        <tr>
                            <td>联系电话</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="phone" maxlength="14" />
                            </td>
                        </tr>
                        <tr>
                            <td>公司名称</td>
                        ...
                        <tr>
                            <td>操作权限</td>
                            <td>
                                <?php if(is_array($shiplist)): $i = 0; $__LIST__ = $shiplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!-- <label><?php echo ($v['shipname']); ?>
                                    <input type="checkbox" name='operation_jur[]' value="<?php echo ($v['id']); ?>"> </label>-->
                                    <label>
                                        <input class="ace ace-checkbox-2" type="checkbox" name='operation_jur[]' value="<?php echo ($v['id']); ?>"/>
...
<!--     <script type="text/javascript">
    ...
    $("select[name=firmid]").change(function() {
        var ajaxship = $("#ajaxship");
        var id = $(this).val();
        if (id == '') {
            ajaxship.empty();
        } else {
            $.ajax({
                url: "<?php echo U('GetAjax/shipListCheckbox');?>",
                data: 'firmid=' + id,
                type: 'post',
                async: false,
                dataType: 'html',
