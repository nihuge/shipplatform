    ...
    <div class="page-container">
        <div class="col-sm-12">
            <div id="home4" class="tab-pane in active">
                <form action="/admin.php?s=/Admin/add" method="post">
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-15 col-sm-8" name="title" maxlength="15" required/>
                            </td>
                        </tr>
                        <tr>
                            <td>用&nbsp;户&nbsp;&nbsp;名</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="name" maxlength="15" required/>
                            </td>
                        </tr>
                        <tr>
                            <td>联系电话</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="phone" maxlength="14" required/>
                            </td>
                        </tr>
                        <tr>
                            <td>用户角色</td>
