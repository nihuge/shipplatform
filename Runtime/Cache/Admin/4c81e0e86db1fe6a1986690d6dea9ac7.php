...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="page-container">
        <form action="/admin.php?s=/Cabin/add" method="post">
            <div style='width:800px;margin:auto auto;'>
                所属船：
                <select style="width: 200px;" name="shipid" required id='shipid'>
                    <option value="">----&nbsp;选&nbsp;择&nbsp;船&nbsp;舶&nbsp;----</option>
                    <?php if(is_array($shiplist)): $i = 0; $__LIST__ = $shiplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['id']); ?>" NUMBER="<?php echo ($v['cabinnum']); ?>" SUANFA="<?php echo ($v['suanfa']); ?>"><?php echo ($v['shipname']); ?>
