...
<div class="main-container ace-save-state" id="main-container">
	...
	<div class="page-container">
        <div>
            <a href="<?php echo U('AuthGroup/add');?>" class="btn btn-primary">新增</a>
        </div>
        <h4></h4>
		<table id="sample-table-1" class="table table-striped table-bordered table-hover">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
					<td><?php echo ($v['title']); ?></td>
					<td>
                        <?php if($v['title'] != '超级管理员'): ?><a href="<?php echo U('AuthGroup/edit',array('id'=>$v['id']));?>">修改</a>&nbsp;|&nbsp;<?php endif; ?>
                        <a href="javascript:;" onclick="del('<?php echo ($v['id']); ?>')">删除</a>&nbsp;|&nbsp;
                        <a href="<?php echo U('AuthGroup/rule_group',array('id'=>$v['id']));?>">分配权限</a> &nbsp;|&nbsp;
                        <a href="<?php echo U('AuthGroup/look_user',array('id'=>$v['id']));?>">点击查看用户列表</a>
                    </td>
