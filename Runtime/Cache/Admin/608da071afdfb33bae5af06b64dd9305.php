...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="page-container">
        <div>
            <form action="/admin.php?s=/Ship/index" method="get">
        ...
        <div>
            <a href="<?php echo U('Ship/add');?>" class="btn btn-primary">新增</a>
        </div>
        <h4></h4>
        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr align='center'>
                    ...
                    <td>
                        <a href="<?php echo U('Ship/edit',array('id'=>$v['id']));?>">修改</a>
                        &nbsp;/&nbsp;
                        <a href="<?php echo U('Ship/sort',array('id'=>$v['id']));?>">舱名排序</a>
                        &nbsp;/&nbsp;
                        <?php if($v['del_sign'] == 1): ?><a href="javascript:;" onclick="delShip(<?php echo ($v['id']); ?>)" style="color:#3ca0fe">删除</a>
                            <?php else: ?>
                            <a href="javascript:;" onclick="recoverShip(<?php echo ($v['id']); ?>)" style="color:#3ca0fe">恢复</a>
                            <?php if($adminmsg['group_id'] == 1): ?>&nbsp;/&nbsp;<a href="javascript:;" onclick="relDelShip(<?php echo ($v['id']); ?>)"
