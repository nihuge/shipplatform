...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="page-container">
        <form action="/admin.php?s=/Article/edit" method="post">
        ...
        <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:900px;margin:auto auto;text-align: center;'>
            <tr>
                ...
                <td>
                    <input class="col-xs-10 col-sm-5" type="text" required name="title" value="<?php echo ($data['title']); ?>"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">发布人</td>
                <td>
                    <input class="col-xs-10 col-sm-5" type="text" required name="author"  maxlength="15" value="<?php echo ($data['author']); ?>"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">资讯内容</td>
                <td>
                    <script id="container" name="content" type="text/plain"><?php echo ($data['content']); ?></script>
                    <script src="/Public/Admin/static/ueditor1_4_3/ueditor.config.js"></script>
                    <script src="/Public/Admin/static/ueditor1_4_3/ueditor.all.js"></script>
                    <script>
                        var ue = UE.getEditor('container',{initialFrameHeight:600,initialFrameWidth:800 });
                    </script>
                </td>
            </tr>
            <tr>
                ...
                <td style="text-align: left;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
                        <input name="is_show" type="radio" class="ace" value="1" <?php echo ($data['is_show'] == '1' ? 'checked' : ''); ?>/>
                        <span class="lbl"> 是 </span>
                    </label>
                    &nbsp;&nbsp;
                    <label>
                        <input name="is_show" type="radio" class="ace" value="0" <?php echo ($data['is_show'] == '1' ? '' : 'checked'); ?>/>
