...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="page-container">
        <form action="/admin.php?s=/Upload/index" method="post" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td>
                        <select name="shipid" id="shipid" required class="col-xs-10 col-sm-5">
                            ...
                            <?php if(is_array($shiplist)): $i = 0; $__LIST__ = $shiplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option id="shipid_<?php echo ($v['id']); ?>" value="<?php echo ($v['id']); ?>"><?php echo ($v['shipname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
            ...
            $("select[name=shipid]").change(function () {
                if ($(this).children().is(':selected')) {
                    ...
                    if (id !== '') {
                        ...
                        var tname = $("#tname");
                        $.ajax({
                            url: "<?php echo U('Upload/cabin_op');?>",
                            data: 'shipid=' + id,
                            type: 'post',
                            async: false,
                            dataType: 'html',
