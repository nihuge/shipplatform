...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="page-container">
        <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
            <form action="/shipplatform2/admin.php?s=/Firm/add" method="post">
                <tr>
                    <td>公司LOGO</td>
                    <td>
                        <img class="normalFace" src="/shipplatform2/Public/Admin/profile-pic.jpg" onclick="fileSelect();" style='width: 100px;height: 110px;'>
                ...
                <tr>
                    <td>报表模板名称</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="pdf" maxlength="20"/>
                    </td>
                </tr>
                <tr>
                    <td>公司名称</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="firmname" required maxlength="30" />
                    </td>
                </tr>
                <tr>
                    <td>公司类型</td>
                    <td>
                        <select class=" col-xs-10 col-sm-8" id="form-field-select-1" name="firmtype">
                            <option value="1">检验公司</option>
                            <option value="2">船舶公司</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td>社会信用代码</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="shehuicode" required maxlength="50" />
                    </td>
                </tr>
                <tr>
                    <td>社会信用代码图片</td>
                    <td>
                        <img class="normalFace" src="/shipplatform2/Public/Admin/noimg.png" onclick="fileSelect1();" style='width: 150px;height: 110px;'>
                ...
                <tr>
                    <td>公司地址</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="location" required maxlength="45" />
                    </td>
                </tr>
                <tr>
                    <td>公司简介</td>
                    <td style="text-align: left;">
                        <textarea name="content" id="" cols="25" rows="10" required maxlength="500" ></textarea>
                    </td>
                </tr>
                <tr>
                    <td>联&nbsp;系&nbsp;&nbsp;人</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="people" maxlength="10" required/>
                    </td>
                </tr>
                <tr>
                    <td>联系电话</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="phone" maxlength="16" required/>
                    </td>
                </tr>
                <tr>
                    <td>合同编号</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="number" maxlength="48" required/>
                    </td>
                </tr>
                <tr>
                    <td>到期时间</td>
                ...
                <tr>
                    <td>服务费标准</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="service" maxlength="4" value="0" required/>
                    </td>
                </tr>
                <tr>
                    <td>账户余额</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="balance" maxlength="11" value="0" readonly/>
                    </td>
                </tr>
                <tr>
                    <td>信用额度</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="creditline" maxlength="8" value="0" required/>
                    </td>
                </tr>
                <tr>
                    <td>船舶限制</td>
                    <td>
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="limit" maxlength="5" value="0" required/>
                    </td>
                </tr>
                <tr>
                    <td>公司图片</td>
                    <td>
                        <img class="normalFace" src="<?php echo ($data['image'] == '') ? '/shipplatform2/Public/Admin/noimg.png' : $data['image'];?>" onclick="fileSelect2();" style='width: 150px;height: 110px;'>
    ...
    <script src="/shipplatform2/Public/Admin/static/ajaximg/jquery.min.js"></script>
    <script src="/shipplatform2/Public/Admin/static/ajaximg/lrz.all.bundle.js"></script>
    <script type="text/javascript">
    laydate.render({
        elem: '#test1' //指定元素
            ,
