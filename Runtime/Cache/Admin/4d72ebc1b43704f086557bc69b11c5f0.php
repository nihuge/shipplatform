    ...
    <div class="page-container">
        <div class="col-sm-12">
            <div id="home1" class="tab-pane in active">
                <form action="/admin.php?s=/Firm/addpersonality" method="post">
                ...
                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($perlist)): foreach($perlist as $k=>$v): ?><tr class='b-group'>
                            <td>
                                <input class="input-medium" readonly style="width:40px;height:25px;" type="text" name="<?php echo ($v["id"]); ?>" value="<?php
 foreach($data as $key => $value){ if($v['id'] == $value){ echo $key; } } ?>">
                            </td>
                            <td><label><input type="checkbox" class="ace ace-checkbox-2" name="personality[]" <?php echo in_array($v['id'],$data) ? 'checked' : '';?>><span class="lbl">  <?php echo ($v["title"]); ?></span> </label></td>
    ...
    <script type="text/javascript">
        ...
        $(":checkbox[type=checkbox]").change(function(){
            var a = $(this).parents('.b-group').eq(0).find("input[type='text']");
            if($(this).is(':checked')){
