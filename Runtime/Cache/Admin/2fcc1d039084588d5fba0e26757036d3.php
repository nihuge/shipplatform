    ...
    <div class="page-container">
        <div class="col-sm-12">
            <div id="home4" class="tab-pane in active">
                <form action="/admin.php?s=/AuthRule/edit" method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
                        <tr>
                            <td>父&nbsp;&nbsp;节&nbsp;&nbsp;点</td>
                            <td>
                                <select class=" col-xs-10 col-sm-8" id="form-field-select-1" name="pid" required>
                                    ...
                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>"
                                        <?php echo ($vo['id'] == $msg['pid']) ? 'selected' : ''; ?>
                                        >
                                        <?php echo ($vo['_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>权限中文名称</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-15 col-sm-8" name="title" value="<?php echo ($msg['title']); ?>" required/>
                            </td>
                        </tr>
                        <tr>
                            <td>权限英文名称</td>
                            <td>
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-8" name="name" value="<?php echo ($msg['name']); ?>" required/>
                            </td>
                        </tr>
                        <tr>
