...
<div class="main-container ace-save-state" id="main-container">
	...
	<div class="page-container">
		<table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
            <form action="/admin.php?s=/Rong/edit" method="post">
                ...
                <td>
                    <select class=" col-xs-10 col-sm-5" id="form-field-select-1" name="cabinid" required>
                        <?php if(is_array($cabinlist)): $i = 0; $__LIST__ = $cabinlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['id']); ?>"
                            <?php if($v['id'] == $msg['cabinid']): ?>selected<?php endif; ?>
            ...
            <tr>
                <td style="width:120px;">容量</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['capacity']); ?>" name="capacity"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">厘米容量</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['diff']); ?>" name="diff"/>
                </td>
            </tr>
            <tr>
