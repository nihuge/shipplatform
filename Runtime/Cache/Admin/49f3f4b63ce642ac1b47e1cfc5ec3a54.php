...
<div class="main-container ace-save-state" id="main-container">
	...
	<div class="page-container">
		<table id="sample-table-1" class="table table-striped table-bordered table-hover" style='width:500px;margin:auto auto;text-align: center;'>
            <form action="/admin.php?s=/Cabin/edit" method="post">
            <input type="hidden" name="id" value="<?php echo ($msg['id']); ?>">
            <tr>
                <td>所属船</td>
                <td>
                    <select class=" col-xs-10 col-sm-5" id="form-field-select-1" name="shipid" required>
                        <?php if(is_array($shiplist)): $i = 0; $__LIST__ = $shiplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['id']); ?>" 
                            <?php if($msg['shipid'] == $v['id']): ?>selected<?php endif; ?>
                             ><?php echo ($v['shipname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">舱名</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['cabinname']); ?>" name="cabinname" maxlength="5"/>
                </td>
            </tr>
            <tr>
                <td style="width:140px;">容量表基准高度(H)</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['altitudeheight']); ?>" name="altitudeheight" maxlength="5"/>
                </td>
            </tr>
            <tr>
                <td style="width:140px;">底量表基准高度(H)</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" value="<?php echo ($msg['dialtitudeheight']); ?>" name="dialtitudeheight" maxlength="5"/>
                </td>
            </tr>
            <tr>
                <td style="width:140px;">容量表底量(D)</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['bottom_volume']); ?>" name="bottom_volume" maxlength="5"/>
                </td>
            </tr>
            <tr>
                <td style="width:140px;">底量表底量(D)</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" value="<?php echo ($msg['bottom_volume_di']); ?>" name="bottom_volume_di" maxlength="5"/>
                </td>
            </tr>
            <tr>
                <td style="width:120px;">管线容量</td>
                <td>
                    <input type="text" id="form-field-1" class="col-xs-15 col-sm-5" required value="<?php echo ($msg['pipe_line']); ?>" name="pipe_line" maxlength="5"/>
                </td>
            </tr>
            <tr>
