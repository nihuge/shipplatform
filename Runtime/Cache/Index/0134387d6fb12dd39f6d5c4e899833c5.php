...
<div class="navwai">
    ...
    <div class='xia'>
        <table id="customers">
            ...
            <tr>
	            ...
	            <td>
                    <div class="evaluate1">  
                        <div id="starts<?php echo ($xu); ?>" class='starts'></div></div>  
                    </div> 
                </td>
	            <td>
	            	<a href="/index.php?s=/Search/chuanmsg/firmid/<?php echo ($v['id']); ?>" class='aa2'>详情</a>
                </td>
            </tr>
    ...
    <script>
        <?php  foreach($data as $v){ static $xu1 = 1; echo '$("#starts'.$xu1.'").raty({ readOnly:true,number:5,path : "/tpl/default/Index/Public/image",starOn:"star-on.png",starOff : "star-off.png",starHalf:"star-half.png",score:'.$v['pin'].',});'; $xu1++; } ?>
    </script>
