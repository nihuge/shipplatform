...
<div class="navwai">
    ...
    <script src="/tpl/default/Index/Public/js/echarts.min.js"></script>
    <div class="biaotis">
            船舶基本信息
    </div>
    ...
    <div class='dadiv'>
       <div class="xinx_3">
        ...
        <div class="xinx_3">
            ...
            <a href="<?php echo U('Search/result',array('shipid'=>$data['id']));?>" style="padding: 5px 10px;background-color: #80aae6;color: #ffffff;font-size: 14px;float: right;margin-right: 10px;border-radius: 5px;">查看历史作业</a>
        </div>
        <div class="xinx_3">
            <p class="pp1">总作业吨位</p>
    ...
    <script>
        ...
        var xAxisData = [
        <?php
 $aaa = ''; foreach ($voyage as $k=>$s) { $aaa .= "'".$s."',"; } echo substr($aaa,0,-1); ?>
        ];
        var data1 = [<?php
 $aaa = ''; foreach ($cha as $k=>$s) { $aaa .= "'".$s."',"; } echo substr($aaa,0,-1); ?>];
