...
<div class="navwai">
	...
	<link rel="stylesheet" href="/shipplatform2/tpl/default/Index/Public/css/liquid.css">
	<link rel="stylesheet" href="/shipplatform2/tpl/default/Index/Public/css/ship.css">
    ...
    <div class='xia'>
        <table id="customers">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr style="color:<?php echo ($v['colors']); ?>">
	            ...
	            <td><a href="javascript:;" onclick="edit(<?php echo ($v['id']); ?>)" class="aa1">修改</a></td>
            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            <tr style="background-color: #fff">
            	<td colspan="6" style="border-right: 0px;"><?php echo ($page); ?></td>
            </tr>
        </table>
    </div>
    <!-- 修改船舱 -->
