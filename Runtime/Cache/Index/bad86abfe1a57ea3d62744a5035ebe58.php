...
<div class="navwai">
    ...
    <script type="text/javascript">
    $(function() {
        $(".shipdiv .panel:first").next().show();
        $(".panel .look").click(function() {
            var images=['/tpl/default/Index/Public/image/w-d.png','/tpl/default/Index/Public/image/w-u.png'];
	...
	<div style="background-color: #f2f2f2;padding: 25px 30px;">
        <div class='nav'>
            作业系统>液货船系统>作业数据详情
        </div>
    </div>
    <div class='shipdiv'>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v11): $mod = ($i % 2 );++$i;?><div class="panel">
            <div class="head1">
                船名：<?php echo ($v11['shipname']); ?>
                <span class='look'>
                    <p style="display: inline-block;color:#efff3c;margin-right: 10px;">航次：<?php echo ($v11['voyage']); ?></p>
                    <p style="display: inline-block;color:#fff;">查看详情</p>
            ...
            <div class="contentsss">
                <div class='rmsg1'>
                    <div class='msgs'>
                        <p class='pp11'>船名</p>
                        <p class='pp22'><?php echo ($v11['shipname']); ?></p>
                    </div>
                    <div class='msgs'>
                        <p class='pp11'>操作人</p>
                        <p class='pp22'><?php echo ($v11['username']); ?></p>
                    </div>
                    <div class='msgs'>
                        <p class='pp11'>货重(吨)</p>
                        <p class='pp22'><?php echo ($v11['weight']); ?></p>
                    </div>
                    <?php if(is_array($v11["personality_array"])): foreach($v11["personality_array"] as $k=>$voo): ?><div class='msgs'>
                        <p class='pp11'><?php echo ($voo['title']); ?></p>
                        <p class='pp22'><?php echo ($voo['value']); ?></p>
                    ...
                    <div class='chi'>
                        <div class='shui'>
                            ...
                            <div class='chishuimsg'>
                                <p class='pp11'>艏吃水</p>
                                <p class='pp22'><?php echo ($v11['qianchi']['forntleft']); ?>
                                <?php
 $n = count($v11['firstfiles1']); echo '<span>'; for($i=0;$i<$n;$i++) { echo '<a layer-href="'.$v11['firstfiles1'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a>'; } echo '</span>'; ?>
                                </p>
                            </div>
                            <div class='chishuimsg'>
                                <p class='pp11'>艉吃水</p>
                                <p class='pp22'><?php echo ($v11['qianchi']['afterleft']); ?>
                                <?php
 $n = count($v11['tailfiles1']); echo '<span>'; for($i=0;$i<$n;$i++) { echo '<a layer-href="'.$v11['tailfiles1'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a>'; } echo '</span>'; ?>
                                </p>
                            </div>
                            <div class='chishuimsg'>
                                <p class='pp11'>实验室密度</p>
                                <p class='pp22'><?php echo ($v11['qiandensity']); ?></p>
                            </div>
                        ...
                        <div class='shui'>
                            ...
                            <div class='chishuimsg'>
                                <p class='pp11'>艏吃水</p>
                                <p class='pp22'><?php echo ($v11['houchi']['forntleft']); ?>
                                <?php
 $n = count($v11['firstfiles2']); echo '<span>'; for($i=0;$i<$n;$i++) { echo '<a layer-href="'.$v11['firstfiles2'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a>'; } echo '</span>'; ?>
                                </p>
                            </div>
                            <div class='chishuimsg'>
                                <p class='pp11'>艉吃水</p>
                                <p class='pp22'><?php echo ($v11['houchi']['afterleft']); ?>
                                <?php
 $n = count($v11['tailfiles2']); echo '<span>'; for($i=0;$i<$n;$i++) { echo '<a layer-href="'.$v11['tailfiles2'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a>'; } echo '</span>'; ?>
                                </p>
                            </div>
                            <div class='chishuimsg'>
                                <p class='pp11'>实验室密度</p>
                                <p class='pp22'><?php echo ($v11['houdensity']); ?></p>
                            </div>
                            <div class='chishuimsg'></div>
                        </div>
                    </div>
                    <div class='cabindiv'>
                        <div class='divcabin'>
                            <?php if(is_array($v11["qian"])): $i = 0; $__LIST__ = $v11["qian"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $i=0;?>
                            <div class="panel">
                                <div class="head1">
                                ...
                                <div class="contentss">
                                    <table border="1" cellspacing="0" cellpadding="0" class="table">
                                        <tr>
                                            <td>
                                                <p class='pp11'>空高</p>
                                                <p class='pp22'><?php echo ($vo['ullage']); ?>
                                                <?php
 $n = count($vo['ullageimg']); echo '<span>'; for($i=0;$i<$n;$i++) { echo '<a layer-href="'.$vo['ullageimg'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a>'; } echo '</span>'; ?>
                                            ...
                                            <td>
                                                <p class='pp11'>实高</p>
                                                <p class='pp22'><?php echo ($vo['sounding']); ?>
                                                <?php
 $n = count($vo['soundingimg']); echo '<span>'; for($i=0;$i<$n;$i++) { echo '<a layer-href="'.$vo['soundingimg'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a>'; } echo '</span>'; ?>
                                        ...
                                        <tr>
                                            <td>
                                                <p class='pp11'>温度</p>
                                                <p class='pp22'><?php echo ($vo['temperature']); ?>
                                                <?php
 $n = count($vo['temperatureimg']); for($i=0;$i<$n;$i++) { echo '<span><a layer-href="'.$vo['temperatureimg'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a></span>'; } ?>
                                                </p>
                                            </td>
                                            <td>
                                                <p class='pp11'>纵倾修正值</p>
                                                <p class='pp22'><?php echo ($vo['listcorrection']); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class='pp11'>修正后空距</p>
                                                <p class='pp22'><?php echo ($vo['correntkong']); ?></p>
                                            </td>
                                            <td>
                                                <p class='pp11'>容量</p>
                                                <p class='pp22'><?php echo ($vo['standardcapacity']); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class='pp11'>体积修正系数</p>
                                                <p class='pp22'><?php echo ($vo['volume']); ?></p>
                                            </td>
                                            <td>
                                                <p class='pp11'>膨胀修正系数</p>
                                                <p class='pp22'><?php echo ($vo['expand']); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class='pp11'>标准容量</p>
                                                <p class='pp22'><?php echo ($vo['cabinweight']); ?></p>
                                            </td>
                                            <td>
                                                <p class='pp11'></p>
                                                <p class='pp22'></p>
                        ...
                        <div class='divcabin'>
                            <?php if(is_array($v11["hou"])): $i = 0; $__LIST__ = $v11["hou"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i; $i=0;?>
                            <div class="panel">
                                <div class="head1">
                                    舱名：<?php echo ($v1['cabinname']); ?>
                                    <span class='look'>
                                        <img src="/tpl/default/Index/Public/image/w-d.png">
                                    </span>
                                </div>
                                <div class="contentss">
                                    <table border="1" cellspacing="0" cellpadding="0"  class="table">
                                        <tr>
                                            <td>
                                                <p class='pp11'>空高</p>
                                                <p class='pp22'><?php echo ($v1['ullage']); ?>
                                                <?php
 $n = count($v1['ullageimg']); echo '<span>'; for($i=0;$i<$n;$i++) { echo '<a layer-href="'.$v1['ullageimg'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a>'; } echo '</span>'; ?>
                                                </p>
                                            </td>
                                            <td>
                                                <p class='pp11'>实高</p>
                                                <p class='pp22'><?php echo ($v1['sounding']); ?>
                                                <?php
 $n = count($v1['soundingimg']); echo '<span>'; for($i=0;$i<$n;$i++) { echo '<a layer-href="'.$v1['soundingimg'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a>'; } echo '</span>'; ?>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class='pp11'>温度</p>
                                                <p class='pp22'><?php echo ($v1['temperature']); ?>
                                                <?php
 $n = count($v1['temperatureimg']); echo '<span>'; for($i=0;$i<$n;$i++) { echo '<a layer-href="'.$v1['temperatureimg'][$i].'" class="" rel="gallery"><span class="showphoto">'; if ($i == 0) { echo '<img src="/tpl/default/Index/Public/image/check.png" style="vertical-align: middle;margin-left:7px;">'; } echo '</span></a>'; } echo '</span>'; ?>
                                                </p>
                                            </td>
                                            <td>
                                                <p class='pp11'>纵倾修正值</p>
                                                <p class='pp22'><?php echo ($v1['listcorrection']); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class='pp11'>修正后空距</p>
                                                <p class='pp22'><?php echo ($v1['correntkong']); ?></p>
                                            </td>
                                            <td>
                                                <p class='pp11'>容量</p>
                                                <p class='pp22'><?php echo ($v1['standardcapacity']); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class='pp11'>体积修正系数</p>
                                                <p class='pp22'><?php echo ($v1['volume']); ?></p>
                                            </td>
                                            <td>
                                                <p class='pp11'>膨胀修正系数</p>
                                                <p class='pp22'><?php echo ($v1['expand']); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class='pp11'>标准容量</p>
                                                <p class='pp22'><?php echo ($v1['cabinweight']); ?></p>
                                            </td>
                                            <td>
                                                <p class='pp11'></p>
                                                <p class='pp22'></p>
                    ...
                    <div class='remarks'>
                        <p class='ppp3'>备注</p>
                        <p class='pp4'><?php echo ($v11['remark']); ?></p>
                    </div>
                </div>
            </div>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    <div style="margin-bottom: 50px;"><?php echo ($page); ?></div>
