...
<div class="navwai">
    ...
    <script src="/tpl/default/Index/Public/js/jquery-1.9.1.min.js"></script> 
    ...
    <div class='xia'>
        <table id="customers">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; static $xu = 1;?>
            <tr>
	            ...
	            <td>
                    <div class="evaluate1">  
                        <div id="starts<?php echo ($xu); ?>" class='starts'></div> 
                    </div> 
                </td>
	            <td>
	            	<a href="/index.php?s=/Search/jianmsg/firmid/<?php echo ($v['id']); ?>" class='aa2'>详情</a>
                </td>
            </tr>
            <?php $xu++; endforeach; endif; else: echo "" ;endif; ?>
            <tr style="background-color: #fff;">
            	<td colspan="5" style="border-right: 0px;"><?php echo ($page); ?></td>
            </tr>
        </table>
    </div>
    <script>
        <?php  foreach($data as $v){ static $xu1 = 1; echo '$("#starts'.$xu1.'").raty({ readOnly: true, number : 5,path : "/tpl/default/Index/Public/image",starOn : "star-on.png",starOff : "star-off.png",starHalf    : "star-half.png",precision: true,score:'.$v['pin'].',});'; $xu1++; } ?>
    </script>
